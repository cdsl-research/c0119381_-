...
while True:
    ...
    print("%d,%d,%d" % (data[0],data[1],data[2],data[3],data[4],data[5]))
    d1 = data[0]
    d2 = data[1]
    d3 = data[2]
    d4 = data[3]
    d5 = data[4]
    d6 = data[5]
    csvWriteChildList.append(d1)
    csvWriteChildList.append(d2)
    csvWriteChildList.append(d3)
    csvWriteChildList.append(d4)
    csvWriteChildList.append(d5)
    csvWriteChildList.append(d6)
